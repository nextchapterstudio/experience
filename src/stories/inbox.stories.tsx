    ...
    <Card onClick={msg.onClick} className={active ? 'active' : ''}>
      <CardBody>
        <div className="msg-header">
          ...
          <span className="msg-timestamp">{new Date(msg.timestamp).toDateString()}</span>
...
export const InboxTemplate = () => {
  ...
  return (
    <>
      ...
      <Columns>
        <Column as="aside" is="2" isFullheight className="aside hero is-fullheight">
          <div>
        ...
        <Column className="column is-4 messages hero is-fullheight" id="message-feed">
...
export default {
  title: 'Templates/Inbox',
  component: InboxTemplate,
} as ComponentMeta<typeof InboxTemplate>
