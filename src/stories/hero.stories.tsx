    ...
    <>
      ...
      <Box className="cta">
        <p className="has-text-centered">
          <Tag isPrimary>New</Tag> Ut enim ad minim veniam, quis nostrud exercitation ullamco
      ...
      <Container>
            ...
            <Card className="is-shady">
              ...
              <CardBody>
                <Content>
                  ...
                  <p>
                    Purus semper eget duis at tellus at urna condimentum mattis. Non blandit massa
            ...
            <Card className="is-shady">
              ...
              <CardBody>
                <Content>
                  ...
                  <p>
                    Ut venenatis tellus in metus vulputate. Amet consectetur adipiscing elit
            ...
            <Card className="is-shady">
              ...
              <CardBody>
                <Content>
                  ...
                  <p>
                    Imperdiet dui accumsan sit amet nulla facilisi morbi. Fusce ut placerat orci
                    nulla pellentesque dignissim enim. Libero id faucibus nisl tincidunt eget
                    nullam. Commodo viverra maecenas accumsan lacus vel facilisis.
                  </p>
                  <p>
                    <a href="#">Learn more</a>
                  </p>
        ...
        <Column size="8" className="intro is-offset-2">
          ...
          <br />
          <SubTitle as="p">
            Vel fringilla est ullamcorper eget nulla facilisi. Nulla facilisi nullam vehicula ipsum
            a. Neque egestas congue quisque egestas diam in arcu cursus.
          </SubTitle>
        </Column>
              ...
              <Tile className="tile">
                ...
                <Tile isParent>
                  <Tile isChild isNotification isWhite>
                    ...
                    <Image is4by3 src="https://picsum.photos/640/480/?random" alt="Description" />
                  </Tile>
                </Tile>
              </Tile>
              <Tile isParent className="is-shady">
                ...
                <Content>
                  ...
                  <Content>
                    ...
                    <p>
                      ...
                      sagittis. Pellentesque interdum, nisl nec interdum maximus, augue diam
                      porttitor lorem, et sollicitudin felis neque sit amet erat. Maecenas imperdiet
                      felis nisi, fringilla luctus felis hendrerit sit amet. Aenean vitae gravida
                    ...
                    <p>
                      ...
                      congue lectus dolor consequat libero. Donec leo ligula, maximus et
                      pellentesque sed, gravida a metus. Cras ullamcorper a nunc ac porta. Aliquam
          ...
          <Tile isAncestor>
            <Tile isParent size="8" className="is-shady">
              <Tile isChild isNotification isWhite>
                ...
                <SubTitle as="p">Anything that can go wrong will go wrong</SubTitle>
                <Content>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna
                    eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam
            ...
            <Tile isParent className="is-shady">
              <Tile isChild isNotification isWhite className="tile is-child notification is-white">
                <Title as="p">Main column</Title>
                <SubTitle as="p">With some content</SubTitle>
                <Content>
                  <p>
