          ...
          <Columns>
            <Column is="12" className="column is-12">
              <Container className="content">
                <BaseIcon fab isLargeFA icon="discord" /> <BaseIcon fas isLargeFA icon="code" />
                <Title>
                  Code <em>All</em> The Things
                </Title>
                <SubTitle>Collection of code goodies for next-level dev</SubTitle>
                <Button
                  isAnchor
                  isPrimary
                  isLarge
              ...
              <Content isMedium>
                ...
                <Box className="box">
                  ...
                  <Message isPrimary>
                    ...
                    <MessageBody>Block-scoped. Cannot be re-assigned. Not immutable.</MessageBody>
                  </Message>
                  <pre>
                ...
                <Box className="box">
                  ...
                  <Message isPrimary className="message is-primary">
                    <Icon icon="info-circle" fas hasTextPrimary />
                    <MessageBody>
                      Lorem ipsum dolor sit amet, mea ne viderer veritus menandri, id scaevola
                      gloriatur instructior sit.
                    </MessageBody>
                  </Message>
                  <pre>
                    <code className="language-javascript">let i = 0;</code>
          ...
          <Container className="container">
            <Columns isMultiline>
                ...
                <MediaObject className="notification  has-background-white">
                  ...
                  <MediaContent>
                    <Content>
                      ...
                      <SubTitle as="p" is="5">
                        The indispensable <strong>form controls</strong>, designed for maximum
                        clarity
                      </SubTitle>
                    </Content>
                  </MediaContent>
              ...
              <Column isOneThird>
                <MediaObject className="notification has-background-white">
                  <MediaLeft>
                    <Icon fas icon="warehouse" className="fa-lg" hasTextPrimary />
                  </MediaLeft>
                  <MediaContent>
                    <Content>
                      <Title is="4" as="h1">
...
} as ComponentMeta<typeof CheatSheetTemplate>
